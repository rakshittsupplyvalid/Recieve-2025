    ...
    >
      {profileData?.role === 'StorageAdmin' ? (
        ...
        <>
          ...
          <Drawer.Screen name="Normal Health Report Form"
            component={TestForm}
            options={{
              headerShown: false,
              drawerIcon: ({ color, size }) => <Icon name="insert-drive-file" size={size} color={color} />
            }}
          />


          <Drawer.Screen name="CA Health Report Form"
