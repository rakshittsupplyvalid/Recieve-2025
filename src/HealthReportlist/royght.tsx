...
interface Report {
    ...
    bagCount: number;
    blackSmutOnion: boolean;
    blackSmutPercent: number;
    comment: string;
    destinationBranch: string;
    files?: string[];
    fpcPersonName: string;
    grossWeight: number;
    healthReportDispatchType: string;
    moisture: string;
    moisturePercent: number;
    onionSkin: string;
    onionSkinPercent: number;
    size: number;
    spoiledOnion: boolean;
    spoiledPercent: number;
    sproutedOnion: boolean;
    sproutedPercent: number;
    stainingColour: boolean;
...
const HealthReportDetails = () => {
    ...
    const calculateNetWeight = () => {
        if (report?.grossWeight && report?.tareWeight) {
            return report.grossWeight - report.tareWeight;
        }
        return 0;
    };
            ...
            >
                <View style={styles.card}>
                    <View style={styles.cardHeader}>
                        <FontAwesome name="info-circle" size={20} color="#F79B00" />
                    ...
                    <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailValue}>{report.assayerName}</Text>
                    </View>
                    ...
                    <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailValue}>{report.fpcPersonName}</Text>
                    </View>

                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Dispatch Type</Text>
                        <Text style={styles.detailValue}>{report.healthReportDispatchType}</Text>
                    </View>
                </View>

                <View style={styles.card}>
                    <View style={styles.cardHeader}>
                        <FontAwesome name="balance-scale" size={20} color="#F79B00" />
                        <Text style={styles.cardTitle}>{t('WeightInformation')}</Text>
                    </View>

                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Bag Count</Text>
                        <Text style={styles.detailValue}>{report.bagCount}</Text>
                    </View>

                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Gross Weight (kg)</Text>
                        <Text style={styles.detailValue}>{report.grossWeight}</Text>
                    </View>

                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Tare Weight (kg)</Text>
                        <Text style={styles.detailValue}>{report.tareWeight}</Text>
                    </View>

                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Net Weight (kg)</Text>
                        <Text style={styles.detailValue}>{calculateNetWeight()}</Text>
                    </View>
                </View>
